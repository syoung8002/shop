...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                title: 'Shipping', 
                description: 'Shipping을 관리하는 화면입니다.', 
                key: 'shippings', 
                route: '/deliveries/shippings',
                ImageUrl: '',
            },
            { 
                title: 'Inventory', 
            ...
            { 
                title: 'ProductSearch', 
                description: 'Product Search을 관리하는 화면입니다.', 
                key: 'productSearches', 
                route: '/orders/productSearches',
                ImageUrl: '',
            },
            { 
                title: 'OrderStatus', 
                description: 'OrderStatus을 관리하는 화면입니다.', 
                key: 'orderStatuses', 
                route: '/dashboards/orderStatuses',
                ImageUrl: '',
            },
